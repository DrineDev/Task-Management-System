        ...
        <div class="mb-4">
          ...
          <form action="{{ route('change-email.update') }}" method="POST">
            ...
            <div class="input-box p-4 mb-3 rounded-lg">
              ...
              <input type="email" id="current_email" name="current_email" value="{{ $user->email }}" class="w-full px-3 py-1.5 rounded border border-gray-300" readonly>
            </div>

            <div class="input-box p-4 mb-3 rounded-lg">
              <label for="new_email" class="block text-sm font-semibold mb-1">New Email</label>
              <input type="email" id="new_email" name="new_email" class="w-full px-3 py-1.5 rounded border border-gray-300" required>
            </div>

            <div class="input-box p-4 mb-3 rounded-lg">
              <label for="new_email_confirmation" class="block text-sm font-semibold mb-1">Confirm New Email</label>
              <input type="email" id="new_email_confirmation" name="new_email_confirmation" class="w-full px-3 py-1.5 rounded border border-gray-300" required>
            </div>
