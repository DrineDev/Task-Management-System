     ...
     <div class="flex justify-center">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <input class="bg-stone-200 rounded-xl px-4 py-2 w-full text-black" id="name" type="text" name="name" value="{{ old('name') }}" required autofocus>
                @error('username')
                    <div>{{ $message }}</div>
                @enderror
            </div>
            ...
            <div>
                ...
                <input class="bg-stone-200 rounded-xl px-4 py-2 w-full text-black" id="email" type="email" name="email" value="{{ old('email') }}" required>
                @error('email')
                    <div>{{ $message }}</div>
                @enderror
            </div>
            ...
            <div>
                ...
                <input class="bg-stone-200 rounded-xl px-4 py-2 w-full text-black" id="password" type="password" name="password" required>
                @error('password')
                    <div>{{ $message }}</div>
                @enderror
            </div>
            ...
            <div>
                ...
                <input id="password_confirmation" type="password" name="password_confirmation" class="bg-stone-200 rounded-xl px-4 py-2 w-full text-black" required>
            </div>
